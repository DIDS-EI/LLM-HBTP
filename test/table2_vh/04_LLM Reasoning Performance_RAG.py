...
# ============= VH ================
name = "VH"
default_prompt_file = f"{ROOT_PATH}/../test/SCENES_EXP/prompt_{name}_no_example.txt"
...
# from btgym.envs.RobotHow_Small.exec_lib._base.VHTAction import VHTAction as RHS
